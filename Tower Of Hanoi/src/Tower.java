...
public class Tower extends JPanel implements MouseListener,MouseMotionListener{
	...
	public Tower(int l){
		...
		panel3.add(moveTxt);
		this.add( panel3);
		levell.setBounds(30,40,150, 45);
		levell.setBorder(null);
		this.add(levell);
	...
	public void hint(int n, String string, String string2, String string3){
		if (n == 1)
    {
    ...
    hint(n - 1, string, string3, string2);
    System.out.println("Move disk "+ n + " from " +
                       string +" to " + string2 );
    hint(n - 1, string3, string2, string);
}
